<template>
    <div class="home-page">
        <span class="title">欢迎使用NLPAT</span>
        <div class="doc">
            <div class="subtitle">功能</div>
            <ul class="functions">
                ...
                <li><router-link to='/ai-annotation'>AI自动标注</router-link></li>
...
<style>
    ...
    .home-page .doc .subtitle {
        font-size: 1.2em;
        font-weight: 600;
    }
    .home-page .doc .functions {
        margin-top: 15px;
        margin-left: 20px;
    }
</style>
